        ...
        <div>
            <form className='flex flex-col gap-3 text-left'>
                ...
                <div className='flex flex-col gap-2'>
                    <label htmlFor="api_key" className='text-left'>Api Key: </label>
                ...
                <div className='flex gap-2 justify-center w-1/2'>
                    <button onClick={handleSave} className='p-2 border-black border-2 hover:text-white hover:bg-black w-1/2 min-w-fit'>Save</button>
